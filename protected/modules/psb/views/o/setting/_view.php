...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('field_religion')); ?>:</b>
	<?php echo CHtml::encode($data->field_religion); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('field_wali')); ?>:</b>
	<?php echo CHtml::encode($data->field_wali); ?>
	<br />
