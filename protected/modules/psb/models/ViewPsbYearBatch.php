 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "_view_psb_year_batch".
 *
 * The followings are the available columns in table '_view_psb_year_batch':
 * @property string $batch_id
 * @property string $year_id
 * @property string $registers
 */
class ViewPsbYearBatch extends CActiveRecord
{
	 ...
	 * @return ViewPsbYearBatch the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('batch_id, year_id', 'length', 'max'=>11),
			array('registers', 'length', 'max'=>21),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('batch_id, year_id, registers', 'safe', 'on'=>'search'),
		);
	}
