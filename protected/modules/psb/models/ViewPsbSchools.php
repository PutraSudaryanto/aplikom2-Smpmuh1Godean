 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "_view_psb_schools".
 *
 * The followings are the available columns in table '_view_psb_schools':
 * @property string $school_id
 * @property string $registers
 */
class ViewPsbSchools extends CActiveRecord
{
	 ...
	 * @return ViewPsbSchools the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('school_id', 'length', 'max'=>11),
			array('registers', 'length', 'max'=>21),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('school_id, registers', 'safe', 'on'=>'search'),
		);
	}
