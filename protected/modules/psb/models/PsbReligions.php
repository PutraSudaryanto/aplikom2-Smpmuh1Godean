 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_psb_religions".
 *
 * The followings are the available columns in table 'ommu_psb_religions':
 * @property integer $religion_id
 * @property integer $publish
 * @property integer $religion_name
...
class PsbReligions extends CActiveRecord
{
	 ...
	 * @return PsbReligions the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'religions' => array(self::HAS_MANY, 'PsbReligions', 'religion'),
			'parentreligion' => array(self::HAS_MANY, 'PsbReligions', 'parent_religion'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'religion_name' => Yii::t('attribute', 'Religion Name'),
	...
	public function search()
	{
		...
		$criteria->compare('t.religion_name',$this->religion_name);
		...
		if(!isset($_GET['PsbReligions_sort']))
			$criteria->order = 't.religion_id DESC';
